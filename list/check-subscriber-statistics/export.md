...
2. 주소록의 \[구독자 목록] 오른쪽 위에 있는 \[내보내기 → 구독자별 통계 내보내기]를 클릭합니다.
3. 통계를 조회하고 싶은 기간을 선택한 뒤 \[통계 데이터 만들기]를 클릭하면, 로그인한 이메일 주소로 파일을 내려받을 수 있는 링크가 발송됩니다. 데이터양에 따라 이메일 도착까지 최대 10분 정도 소요됩니다.
4.  이메일에 있는 \[파일 내려받기]를 클릭하여 파일을 내려받습니다.

    _\* 구독자별 통계 데이터는 생성일로부터 최대 24시간 동안 내려받을 수 있습니다._

<figure><img src="../../.gitbook/assets/구독자 통계 내보내기.png" alt=""><figcaption></figcaption></figure>
