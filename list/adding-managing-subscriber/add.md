...
보유하고 있는 구독자 정보가 없다면 처음부터 구독 신청을 받아 구독자를 모집할 수 있습니다.

스티비에서는 주소록마다 연결된 구독 신청 페이지를 제공합니다. 주소록마다 연결된 구독 폼을 사용할 수도 있고, 구독 폼과 이메일 아카이빙 기능이 결합된 페이지를 활용해 구독 신청을 받는 방법도 있습니다.
