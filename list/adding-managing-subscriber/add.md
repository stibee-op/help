...
[주소록 API](../../api-webhook/api.md)를 사용하면 가지고 있는 DB와 스티비 주소록을 연동해서 사용할 수 있습니다. DB와 스티비 주소록이 연동되면 DB에 새로운 고객 정보가 등록되거나 고객 정보가 변경되는 경우 스티비 주소록에 구독자로 추가하거나 수정된 정보가 자동으로 반영되도록 설정할 수 있습니다. \
\
반대로 스티비 주소록에서 구독자 정보가 변경되는 경우 가지고 있는 DB에 자동으로 반영되도록 하는 것도 가능합니다. \[[주소록 웹훅](../../api-webhook/undefined-1.md)]이라는 기능을 사용해 추가로 연동할 수 있습니다.\
\
