...
[스티비 API](https://developers.stibee.com)를 사용하면 내 홈페이지나 서비스에 저장된 회원 DB와 스티비 주소록을 연동해서 사용할 수 있습니다. DB에 새로운 고객 정보가 등록되거나 고객 정보가 변경되는 경우, 스티비 주소록에 구독자로 추가하거나 수정된 정보가 자동으로 반영되도록 설정할 수 있습니다.&#x20;

반대로 스티비 주소록에서 구독자 정보가 변경될 때, 가지고 있는 DB에 자동으로 반영되도록 설정할 수도 있습니다. [주소록 웹훅](../../api-webhook/list-webhook.md) 기능을 사용해 추가로 연동해 주시면 됩니다.  API와 웹훅을 모두 사용하면 DB와 주소록을 완전히 동기화하여 사용할 수 있습니다.
