...
지금까지 보낸 이메일을 모아서 제공하면 구독자에게 어떤 이메일을 받아볼지 정보를 제공할 수 있기 때문에 구독자를 모으는 데 도움이 됩니다. 스티비에서 발송한 이메일은 \[[페이지](https://app.gitbook.com/s/eAMHRdY4ATDXfWZWQs3p/page)]와 \[[아카이브](archive.md#archiving)]를 사용해 간단하게 웹에 게시하고 구독자에게 제공할 수 있습니다.

> **\*주의:** 자동 이메일은 페이지나 아카이브에 발행할 수 없습니다. 필요하신 경우, 일반 이메일로 변환한 뒤 발행해 주세요.

***

## 페이지와 아카이브 차이점 <a href="#difference" id="difference"></a>

스티비에서는 보낸 이메일을 간단하게 모아서 제공할 수 있는 기능으로 \[페이지]와 \[아카이브] 두 가지 기능을 제공하고 있습니다.
...
* 생성 개&#xC218;**:** 아카이브는 주소록당 1개씩 사용이 가능하고, 페이지는 워크스페이스당 1개만 생성할 수 있습니다. 페이지는 아카이브보다 생성할 수 있는 개수가 적지만, 더 많은 기능을 제공하고 있습니다.
...
[유료 구독 주소록](https://app.gitbook.com/s/eAMHRdY4ATDXfWZWQs3p/paid-newsletter)으로 이메일을 보낸 경우에는 유료 구독자에게만 콘텐츠를 공개할 수 있도록 설정하는 것도 가능합니다. 유료 구독자 전용 콘텐츠도 일반 이메일 발행과 마찬가지로 이메일을 보낼 때와 이미 발송이 완료된 이메일 둘 다 발행할 수 있습니다.&#x20;
...
아카이브는 주소록당 1개의 아카이브가 자동으로 생성됩니다. 그리고 아카이브가 연결된 주소록에 발송한 이메일만 아카이브로 발행할 수 있습니다. &#x20;
...
## 발행한 이메일 수정하기 <a href="#modify-published" id="modify-published"></a>

{% hint style="info" %}
페이지가 주소록과 연결되지 않았거나 아카이브를 사용하지 않는 상태라면 제목과 설명을 수정할 수 없습니다.
{% endhint %}

발송이 완료된 이메일이라도 페이지와 아카이브에 표시되는 제목과 설명은 수정할 수 있습니다.

1. 이메일 목록에서 수정하고 싶은 이메일의 \[더 보기(∨) → 발행 설정하기]를 클릭합니다.
2. 제목과 설명을 수정합니다. 제목은 120자, 설명은 60자까지 입력할 수 있습니다.
3. \[저장하기]를 클릭하면 페이지와 아카이브에 바로 반영됩니다.

수정한 제목과 설명은 이메일 목록, 공유용 URL에도 함께 반영됩니다. 이미 구독자의 메일함으로 전달된 이메일의 제목과 미리보기 텍스트는 바뀌지 않습니다.

<div><figure><img src="../../.gitbook/assets/발행설정하기1 (1).png" alt=""><figcaption></figcaption></figure> <figure><img src="../../.gitbook/assets/발행설정하기 (1).png" alt=""><figcaption></figcaption></figure></div>
