...
{% hint style="info" %}
발송 실패 비율이 높다면 발송 속도에도 영향이 있을 수 있습니다. 발송 속도가 고민된다면 발송 실패 구독자 명단 정제 작업으로 발송이 완료되는 속도를 개선하는 효과도 기대할 수 있습니다. 자세한 내용은 [#h\_01ghaef0qtenbzf15bezjbdwx6](../../tip/improve-sending-performance/improve-open-rates.md#h_01ghaef0qtenbzf15bezjbdwx6 "mention") 도움말을 참고해 주세요.
{% endhint %}
...
_소프트바운스로 발송 실패한 구독자에게 이메일을 재발송하는 방법은_ [#undefined-2](../send/resend-email.md#undefined-2 "mention")_도움말을 참고해 주세요._&#x20;
...
* 소프트바운스(메일함 용량 부족): 구독자의 메일함 용량이 꽉 차서발송에 실패했습니다.
...
4. \[이메일 주소]와 \[오픈 수], \[마지막 오픈일]을 클릭해정렬을 변경하여 확인할 수 있습니다.
...
1. 상세통계를 내보내기 싶은 이메일을 클릭해 \[[이메일 대시보드](email-statistics-dashboard.md)]로 이동합니다.
2. 스크롤을 내려 \[성과] 섹션으로 이동한 뒤, \[상세 통계 한 번에 내보내기]를 클릭합니다.
3.  로그인한 이메일 주소로 파일을 내려받을 수 있는 링크가 발송됩니다.

    _\* 상세통계 파일은 생성일로부터 최대 24시간동안 내려받을 수 있습니다._
