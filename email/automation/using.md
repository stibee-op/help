...
\[자동 이메일]은 구독자 한 명, 한 명에게 정확히 보내는 구조에 최적화되어 있습니다. 따라서, 자동 이메일을 한 번에 여러 명의 구독자에게 보내는 경우, [일반 이메일](/broken/pages/feZLraK9afEVSBVIYqUW)과 처리 방식이 달라 발송 완료까지 시간이 오래 걸릴 수 있습니다. 스티비의 자동 이메일 기능을 사용하는 구체적인 방법에 대해 알아봅니다.
...
3. \[자동 이메일]이 만들어지고 이메일이 발송될 \[[주소록](/broken/pages/mQ3AQKcxfXYxzAr3KgkI)]을 선택하는 단계로 이동합니다.
