...
자동 이메일도 발송하기 전에 마지막으로 각 단계에서 입력하거나 설정한 내용을 확인할 수 있습니다. 이 때 자동 이메일의 '종료 시점'도 설정할 수 있습니다. 종료 시점을 설정하면 스케줄에 따라 자동 이메일 발송이 종료됩니다. 종료 시점을 설정하지 않으면 직접 종료하기 전까지 자동 이메일이 계속 발송됩니다. **\*주의:** 종료된 자동 이메일은 재시작할 수 없습니다.
