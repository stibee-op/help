...
\[이메일]을 클릭하면 표시되는 이메일 목록에서 각 이메일이 지금 어떤 상태인지 확인할 수 있습니다. 스티비의 일반이메일 상태는 크게 \[작성중, 예약중, 발송중, 발송완료, 발송오류]로 구분됩니다. 자동이메일의 상태가 궁금한 경우에는 [여기](../automation/sending.md#h\_01gh88jd5svt98k9ww8swjzm83)에서 확인해보세요.
