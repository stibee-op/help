...
### 목차 <a href="#h_01hj5kf7g52mve6vj3ebxa1ypr" id="h_01hj5kf7g52mve6vj3ebxa1ypr"></a>

[포스트마스터 툴 설정하기](broken-reference)

[설정 시작하기](broken-reference)

[도메인 입력하기](broken-reference)

[도메인 인증하기](broken-reference)

[스팸 비율 확인하기](broken-reference)
...
도메인의 설정을 직접 수정할 수 없는 경우라면 내부의 도메인 또는 서버 관리자에게 화면에 표시된 값과 이 도움말의 링크를 함께 전달해 TXT 레코드 추가를 요청해주세요.

TXT 레코드가 정상적으로 추가됐다면 도메인 대시보드에서 status의 상태가 verified로 변경됩니다.
