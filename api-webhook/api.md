...
요청 속도 제한은 스티비 API가 일정 시간 동안 받을 수 있는 요청 횟수의 상한입니다. 안정적인 서비스 제공을 위해 적용되며, 정해진 횟수를 넘긴 요청은 처리되지 않습니다.

API별 최대 요청 수는 다음과 같습니다.
...
요금제별 권한과 정확한 요청 속도 제한은 [각 API 항목별](https://developers.stibee.com/%EC%8A%A4%ED%8B%B0%EB%B9%84-api) 제목 위에도 표시됩니다.



_\* 자동 이메일 API는 1초당 3회, 1회당 256KB로 제한합니다. 자동 이메일 API 사용과 관련한 자세한 내용은_ [_자동 이메일 API 사용하기_](https://help.stibee.com/email/automation/api)_를 참고해 주세요._
