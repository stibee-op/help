...
예비 구독자는 \[[구독하기](/broken/pages/zqMeCYytZh7bxfVG3BRN#undefined-1)] 버튼을 눌러 뉴스레터 구독을 신청할 수 있습니다. 기존 구독자는 \[[로그인](subscriber-guide/login.md)] 버튼을 눌러 페이지에 로그인할 수 있으며, 로그인을 진행하면 \[구독하기] 버튼은 표시되지 않습니다.
