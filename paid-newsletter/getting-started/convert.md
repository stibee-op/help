...
이미 [일반 주소록](https://app.gitbook.com/s/eAMHRdY4ATDXfWZWQs3p/list)을 만들어 무료 구독자를 대상으로 뉴스레터를 발송하다가 같은 구독자를 대상으로 유료 뉴스레터를 발행하고 싶은 경우가 있을 수 있습니다. 일반 주소록에서 유료 구독 주소록으로 변환하는 방법에 관해 알아봅니다.
...
유료 구독 정보 입력이 완료되면 유료 구독 주소록의 대시보드로 이동합니다. 이제 \[구독 폼]에서 [유료 구독](../settings/subscription-form.md)할 수 있는 화면이 표시되도록 설정만 해주면 변환 절차가 마무리됩니다.
