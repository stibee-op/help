...
## 이메일에 \[후원하기] 버튼 추가하기 <a href="#add-donation-box" id="add-donation-box"></a>
...
2. 이메일 대시보드의 \[성과]에서 결제된 기부금을 확인할 수 있습니다. 이메일 대시보드에서 \[상세 통계 → 기부]를 클릭하면 상품별 자세한 성과를 확인할 수 있습니다.
