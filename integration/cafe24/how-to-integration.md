...
카페24와 스티비를 연동하면 카페24 연동 주소록이 생성되고, 카페24 쇼핑몰 회원 정보와 스티비 주소록이 실시간 연동됩니다. 만약, 카페24 연동 주소록에 쇼핑몰 회원이 아닌 외부에서 수집한 구독자 정보를 추가하고 싶다면 [주소록](https://app.gitbook.com/s/eAMHRdY4ATDXfWZWQs3p/list)에서 직접 추가하면 됩니다. 또는 [구독 폼](../../list/gather-subscribers/form.md)을 활용해 구독자를 새롭게 모집할 수도 있습니다.
...
## 카페24 회원 혜택 <a href="#benefits" id="benefits"></a>
