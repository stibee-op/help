...
워크스페이스는 스티비에서 제작한 이메일, 등록한 구독자 등 작업 내용이 저장되고 관리되는 공간을 의미합니다. 워크스페이스는 독립적인 작업 공간이므로 작성한 이메일이나 구독자 정보는 워크스페이스별로 구분되어 관리됩니다. 사용자와 워크스페이스이 차이는 [여기](../overview.md#h_01gs9hg6dwnyw6es064m6at5tw)에서 확인할 수 있습니다.
