...
* 매니저: 사용자의 권한을 수정하거나 워크스페이스의 결제, 페이지 삭제 기능을 사용할 수 없습니다. 나머지 권한은 관리자와 같습니다.
* 에디터: 이메일 제작과 발송이 가능하지만, 구독자를 추가하거나 구독자 정보를 수정할 수는 없습니다.
* 뷰어: 운영 관련 모든 기능이 제한되며, 워크스페이스 데이터 열람(예. 이메일 통계 확인, 미리보기 확인 등)만 가능합니다. _\*뷰어 권한은 구독자 정보에 접근할 수 없습니다._
