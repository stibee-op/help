...
워크스페이스의 기본 정보와 이메일 콘텐츠 공유 설정을 변경하는 방법을 알아봅니다.
...
* 스티비를 사용하는 목적을 더 구체적으로 알려주세요: 스티비를 어떤 목적으로 사용하는지 구체적인 사용 목적을 선택할 수 있습니다. (복수 선택 가능)
...
_\* 이메일 URL이란 웹 페이지에서 이메일 내용을 확인할 수 있는 기능을 말합니다. 자세한 내용은_ [_이메일 공유하기_](../../email/undefined-6/) _도움말을 참고해 주세요._

#### 이메일 콘텐츠를 검색엔진에 노출합니다

이메일을 검색엔진에 노출할지 여부를 설정하는 항목입니다. 이메일을 발송한 뒤, 이메일 URL을 공개된 외부 웹페이지에 공유하면 검색엔진의 크롤링 정책에 따라 시간이 흐르면서 이메일 URL 페이지가 검색엔진에 노출됩니다.
...
워크스페이스를 새로 만드는 방법은 아래 도움말을 참고해 주세요.
