...
<figure><img src="../../.gitbook/assets/2단계 인증.png" alt=""><figcaption></figcaption></figure>
...
{% hint style="info" %}
새로운 환경(브라우저, 기기, IP 주소 등)에서 로그인이 감지되면 계정 보호를 위해 자동으로 2단계 인증이 활성화됩니다. 아래 경우에도 새로운 환경으로 인식합니다.

* 브라우저 캐시를 삭제한 경우
* 시크릿 모드로 접속한 경우
* 기존과 다른 기기나 IP 주소로 로그인한 경우
* 마지막 로그인 후 30일이 지난 경우
{% endhint %}
