...
2. 이때, \[자동 삭제 기능을 사용하시겠습니까? → 아니요]로 [설정](https://help.stibee.com/list/creating-and-managing/create#auto-deletion)합니다. '예'로 두면 첫 발송에서 구독자가 자동 삭제되어 다음 주기에 다시 보낼 수 없습니다.
