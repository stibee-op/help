...
[SPF, DKIM 설정하기](prevent-email-spam-marking.md#h\_01hkxtbqn0casvd7cmfspnv1y0)
...
[DMARC 설정 적용하기](../../email/managing-sender/dmarc.md)
...
\
대표적인 이메일 수신서비스 G메일에서는 스팸 메일로 분류되는 비율을 0.3% 미만으로 관리할 것을 권고하고 있습니다. 모니터링 결과 스팸함으로 분류되는 비율이 기준을 초과한다면 취하지 않은 기술적인 조치들이 있는지 확인해보는 것이 좋습니다. 모든 조치를 취했지만 비율이 여전히 기준을 초과한다면 그때는 관리적인 조치를 수행하며 스팸 분류 비율을 관리하는 것이 좋습니다.
